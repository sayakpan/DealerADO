...
class ServiceFormField(models.Model):
    ...
    help_text = models.TextField(blank=True, verbose_name="Help Text", help_text="Additional information to assist the user. It will be shown in 'i' tag next to field.")
    ...
    auto_capitalize = models.BooleanField(default=False, verbose_name="Auto Capitalize", help_text="Automatically capitalize the input value when sending to API")
