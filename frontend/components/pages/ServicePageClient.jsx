          ...
          {service?.form_fields && service.form_fields.length > 0 && (
            ...
            >
              <div className="w-full flex flex-col gap-4">
                ...
                {/* Submit Button */}
                <div
                  className={`w-full h-12 p-2.5 rounded-2xl shadow-[0px_4px_16px_0px_rgba(0,0,0,0.20)] flex justify-center items-center gap-2.5 transition-colors duration-200 ${
                    submitting ? "bg-gray-400 cursor-not-allowed" : "bg-[#B52628] hover:bg-[#9e1f21] cursor-pointer"
                  }`}
                >
                  <button
                    type="submit"
