...
const ServiceHeaderWithImg = ({ title = "Wallet" }) => {
    return (
        <div className="w-full h-44 relative rounded-bl-[60px] rounded-br-[60px] overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20">
                <h1 className="text-white text-4xl md:text-5xl font-semibold drop-shadow-lg">{title}</h1>
            </div>
        </div>
    )
}
