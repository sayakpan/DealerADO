        ...
        <footer className="bg-[#151C22] relative overflow-hidden w-full pt-4">
            ...
            <div className="hidden lg:block">
                <div className="w-full mx-auto relative h-[522px] overflow-hidden">
                    ...
                    <div className="absolute left-1/2 z-10 top-[320px] w-[1197px] h-[568px] -translate-x-1/2">
                        <Image
                    ...
                    <div className="absolute bottom-0 w-full h-[508px] pointer-events-none">
                        <Image
                    ...
                    {/* Content Layer */}
                    <div className="relative z-10 py-[3rem] px-[5%]">
                        {/* Logo */}
            ...
            <div className="hidden md:block lg:hidden">
                ...
                {/* Car Image with Smoke Effect - Emerging from Bottom */}
                <div className="w-full h-[12rem] relative overflow-hidden">
                    <div className="absolute bottom-0 left-0 w-full h-[16rem]">
                        <Image
                            src="/images/core/footer-car.png"
                            alt="Red sports car"
                            fill
            ...
            <div className="md:hidden">
                ...
                <div className="w-full h-[10rem] relative overflow-hidden">
                    <div className="absolute bottom-0 left-0 w-full h-[14rem]">
                        <Image
                            src="/images/core/footer-car.png"
                            alt="Red sports car"
                            fill
