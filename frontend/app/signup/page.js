    ...
    return (
        <div className="min-h-screen bg-red-700 relative overflow-hidden">
            ...
            <div className="w-full pt-24 h-[945px] sm:h-[1000px] md:h-[1160px] lg:h-[650px] lg:min-h-[680px] relative bg-red-700 overflow-hidden">
                ...
                <div className="w-[120%] h-[2%] sm:h-[26px] md:h-[36px] absolute -left-[3%] sm:-left-[46px] top-[360px] md:top-[406px] lg:top-[536px] origin-top-left rotate-[-6.42deg] bg-white" />
                <div className="w-[120%] h-[1%] sm:h-[18px] md:h-[14px] absolute -left-[3%] sm:-left-[46px] top-[392px] md:top-[456px] lg:top-[587px] origin-top-left rotate-[-6.42deg] bg-white" />
                <div className="w-[120%] h-[1%] sm:h-[10px] md:h-[14px] absolute -left-[3%] sm:-left-[46px] top-[416px] md:top-[480px] lg:top-[610px] origin-top-left rotate-[-6.42deg] bg-slate-700" />
