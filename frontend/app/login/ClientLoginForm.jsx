...
export default function ClientLoginForm({ sessionExpired }) {
    ...
    useEffect(() => {
        if (sessionExpired) {
            ...
            cookies.remove('sessionExpired', { path: '/' });
            
            // Clear any remaining client storage
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                ...
                // Use window.location for full page refresh to ensure server-side auth state is updated
